...
<div style="padding:10px 10px 10px 10px">
	<form id="content" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>用户名:</td>
	            <td><input class="easyui-textbox" name="userName" data-options="required:true,iconCls:'icon-man',iconAlign:'right'" style="width: 280px;"/></td>
	        </tr>
	        <tr>
	            <td>密码:</td>
	            <td><input class="easyui-textbox" type="password" name="password" data-options="required:true,iconCls:'icon-lock',iconAlign:'right'" style="width: 280px;"/>
	            </td>
	        </tr>
	        <tr>
	            <td>姓名:</td>
	        ...
	        <tr>
	            <td>备注:</td>
	            <td>
	                <input class="easyui-textbox" name="note" data-options="required:true,multiline:true" style="margin: 0px; height: 70px; width: 280px;"/>
	            </td>
	        </tr>
	    </table>
	</form>
